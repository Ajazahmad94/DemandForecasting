...
#This function loads a CSV or Excel file and returns a DataFrame with columns named 'ds' and 'y'
#The file must have a header row with column names
#The file must have columns named 'ds' and 'y'
...
def loadCsvExcelFile(file_path):
    ...
    try:
        ...
        if 'ds' not in df.columns or 'y' not in df.columns:
            raise ValueError("Data Frame Columns names issue: The DataFrame must have columns named 'ds' and 'y.  Please make sure these column names are present in your DataFrame.")
